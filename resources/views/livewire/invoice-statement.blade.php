    <table class="table-auto border border-slate-400 w-full bg-white rounded-lg">
        <tr>
            <th colspan="7" class="bg-gray-60 text-center"> TENANT X </th>
        </tr>
        <tr>
        ...
        <tr>
            <td class="px-4 py-2" colspan="6">Rent October</td>
            <td class="px-4 py-2" colspan="1">KES {{number_format(23000)}}</td>
        </tr>
        <tr>
