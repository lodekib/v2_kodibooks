<x-filament-panels::page>
    ...
    <div x-data="{ activeTab: 'Invoices' }">
        <x-filament::tabs label="client area">
            ...
            <x-filament::tabs.item alpine-active="activeTab === 'Payments'" x-on:click="activeTab = 'Payments'" icon="heroicon-s-clipboard-document">
                Payments
            </x-filament::tabs.item>
            <x-filament::tabs.item alpine-active="activeTab === 'Subscriptions'" x-on:click="activeTab = 'Subscriptions'" icon="heroicon-s-clipboard-document">
                Subscriptions
            </x-filament::tabs.item>
        </x-filament::tabs>
